...
export default function DoctorNotifications() {
  ...
  const chatLink = (relatedId) =>
    relatedId
      ? `/doctor/messages?appointmentId=${encodeURIComponent(String(relatedId))}`
      : null;

  return (
    <>
      <DoctorTopbar title="Notifications" subtitle="Alerts for your practice" />
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-slate-600">
                In-app alerts for appointments and messages. Email delivery
